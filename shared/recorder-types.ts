...
export const DEFAULT_RECORDER_SETTINGS: RecorderSettings = { sampleRate: 44100, bitDepth: 16, channels: 1, leadingSilenceMs: 1000, trailingSilenceMs: 1000, readingFontSize: 29 };
