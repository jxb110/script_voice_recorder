...
export type RecorderSettings = { sampleRate: number; bitRate: number; channels: 1 | 2; leadingSilenceMs: number; trailingSilenceMs: number; readingFontSize: number };
export type RecorderStore = { speakers: Speaker[]; projects: ScriptProject[]; settings: RecorderSettings };
export const DEFAULT_RECORDER_SETTINGS: RecorderSettings = { sampleRate: 44100, bitRate: 128000, channels: 1, leadingSilenceMs: 1000, trailingSilenceMs: 1000, readingFontSize: 29 };
