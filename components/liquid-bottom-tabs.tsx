...
const styles = StyleSheet.create({
  shell: { backgroundColor: "rgba(244,249,255,0.48)", borderColor: "rgba(255,255,255,0.96)", borderRadius: 28, borderWidth: 1, height: 74, marginBottom: 8, marginHorizontal: 8, overflow: "visible", shadowColor: "#24467F", shadowOffset: { width: 0, height: 9 }, shadowOpacity: 0.17, shadowRadius: 18 },
  topRim: { backgroundColor: "rgba(255,255,255,0.86)", borderRadius: 999, height: 1.5, left: 22, position: "absolute", right: 22, top: 2 },
  tabRow: { flex: 1, flexDirection: "row", paddingTop: 7 },
  ...
  lens: { backgroundColor: "rgba(235,246,255,0.94)", borderColor: "rgba(255,255,255,0.98)", borderRadius: 26, borderWidth: 1, height: 49, overflow: "hidden", shadowColor: "#3B65D5", shadowOffset: { width: 0, height: 7 }, shadowOpacity: 0.3, shadowRadius: 14, width: 58 },
  lensGlint: { backgroundColor: "rgba(255,255,255,0.95)", borderRadius: 999, height: 11, left: 8, position: "absolute", right: 8, top: 4 },
  lensRim: { borderColor: "rgba(117,167,255,0.52)", borderRadius: 22, borderWidth: 1, bottom: 3, left: 3, position: "absolute", right: 3, top: 3 },
  splash: { backgroundColor: "rgba(111,175,255,0.58)", borderRadius: 36, height: 62, position: "absolute", width: 62 },
  bubble: { borderColor: "rgba(255,255,255,0.96)", borderWidth: 1.2, elevation: 6, position: "absolute", shadowColor: "#345AD1", shadowOpacity: 0.34, shadowRadius: 6 },
  bubbleLeft: { backgroundColor: "#56CFE9", borderRadius: 8, height: 16, left: "24%", top: 11, width: 16 },
  bubbleRight: { backgroundColor: "#7190FF", borderRadius: 10, height: 20, right: "20%", top: 16, width: 20 },
});
