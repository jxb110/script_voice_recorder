  ...
  return (
    <ScreenContainer className="px-5" edges={["top", "left", "right", "bottom"]}>
      <View style={styles.header}>
        ...
        <View style={styles.titleBlock}><Text style={[styles.title, glass.title]}>{copy.title}</Text><Text style={[styles.subtitle, glass.subtitle]}>{copy.subtitle}</Text></View>
