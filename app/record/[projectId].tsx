...
export default function RecordingScreen() {
  ...
  const jumpToSentence = (target: number) => { setCurrentIndex(target); setShowSentencePicker(false); };
      ...
      <View style={styles.page}>
        ...
        <View style={styles.promptBox}>
          ...
          <View style={styles.promptTextWrapper}>
            <Animated.Text style={[styles.promptText, { transform: [{ scale: promptWave.interpolate({ inputRange: [0, 0.36, 1], outputRange: [1, 1.07, 1] }) }] }]}>{promptContent}</Animated.Text>
