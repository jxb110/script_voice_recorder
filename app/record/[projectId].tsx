...
export default function RecordingScreen() {
  ...
  const sendOrRun = (name: "start" | "stop" | "previous" | "next" | "jump" | "play" | "rerecord" | "cancel" | "complete", target = currentIndex) => {
      ...
      <View style={styles.page}>
        ...
        <GlassSurface style={[styles.readingCard, glass.readingCard]} intensity={32}>
          <View style={styles.readingHeader}>
            ...
            <TouchableOpacity accessibilityLabel={t("fontSize")} accessibilityRole="button" hitSlop={8} onPress={() => setShowFontControls((visible) => !visible)} style={[styles.fontButton, glass.fontButton, showFontControls && styles.fontButtonActive]}>
