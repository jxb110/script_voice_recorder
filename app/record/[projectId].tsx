...
export default function RecordingScreen() {
  ...
  const { projects, speakers, settings, saveSentenceRecording } = useRecorder();
  ...
  return (
    <ScreenContainer className="px-5" edges={["top", "left", "right", "bottom"]}>
      <View style={styles.page}>
        ...
        <View style={styles.readingCard}><Text style={styles.readingCaption}>{t("readingText")}</Text><PhoneticText tokens={sentence.tokens} /></View>
