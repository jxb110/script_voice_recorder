...
import { SyncRoomProvider } from "@/lib/sync-room-context";
...
export default function RootLayout() {
  ...
  const content = <GestureHandlerRootView style={{ flex: 1 }}><RecorderProvider><SyncRoomProvider><trpc.Provider client={trpcClient} queryClient={queryClient}><QueryClientProvider client={queryClient}><Stack screenOptions={{ headerShown: false }}><Stack.Screen name="(tabs)" /><Stack.Screen name="oauth/callback" /></Stack><StatusBar style="dark" /></QueryClientProvider></trpc.Provider></SyncRoomProvider></RecorderProvider></GestureHandlerRootView>;
