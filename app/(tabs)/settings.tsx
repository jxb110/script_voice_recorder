...
import { LiquidSegment } from "@/components/liquid-controls";
...
const styles = StyleSheet.create({
  page: { flex: 1, paddingTop: 9 }, topBar: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", paddingBottom: 10 }, titleGroup: { flex: 1, minWidth: 0, paddingRight: 12 }, title: { color: "#182B55", fontSize: 25, fontWeight: "900", letterSpacing: -0.4 }, subtitle: { color: "#61749E", fontSize: 12, lineHeight: 17, marginTop: 3 }, topSave: { alignItems: "center", backgroundColor: "rgba(70,105,222,0.94)", borderColor: "rgba(255,255,255,0.82)", borderRadius: 14, borderWidth: 1, flexDirection: "row", gap: 4, paddingHorizontal: 13, paddingVertical: 10, shadowColor: "#3E5FAC", shadowOpacity: 0.2, shadowRadius: 10 }, topSaveDisabled: { backgroundColor: "rgba(141,160,203,0.7)" }, topSaveText: { color: "#FFFFFF", fontSize: 13, fontWeight: "800" }, card: { borderRadius: 23, flex: 1, justifyContent: "space-between", minHeight: 0, padding: 14 }, formatRow: { alignItems: "center", flexDirection: "row" }, formatIcon: { alignItems: "center", backgroundColor: "rgba(220,248,234,0.72)", borderRadius: 10, height: 32, justifyContent: "center", width: 32 }, formatCopy: { flex: 1, marginLeft: 8 }, formatTitle: { color: "#182B55", fontSize: 15, fontWeight: "900", lineHeight: 21 }, formatHint: { color: "#61749E", fontSize: 11, fontWeight: "700", lineHeight: 15, marginTop: 1 }, fixedBadge: { backgroundColor: "rgba(220,248,234,0.74)", borderRadius: 8, color: "#1E8B61", fontSize: 12, fontWeight: "900", lineHeight: 17, overflow: "hidden", paddingHorizontal: 8, paddingVertical: 5 }, divider: { backgroundColor: "rgba(115,142,196,0.16)", height: 1, marginVertical: 8 }, settingLine: { alignItems: "center", flexDirection: "row", minHeight: 40 }, lineLabel: { color: "#3B527B", fontSize: 13, fontWeight: "800", lineHeight: 18, width: 74 }, lineControl: { flex: 1 }, segment: { backgroundColor: "rgba(221,231,249,0.7)", borderRadius: 10, flexDirection: "row", padding: 2 }, segmentItem: { alignItems: "center", borderRadius: 8, flex: 1, paddingVertical: 6 }, segmentSelected: { backgroundColor: "rgba(255,255,255,0.82)", elevation: 1 }, segmentText: { color: "#61749E", fontSize: 12, fontWeight: "800" }, segmentTextSelected: { color: "#4669DE" }, rateGrid: { flexDirection: "row", gap: 5 }, rateChip: { alignItems: "center", backgroundColor: "rgba(235,241,251,0.72)", borderRadius: 9, flex: 1, paddingVertical: 7 }, rateChipSelected: { backgroundColor: "rgba(228,237,255,0.9)", borderColor: "#4B6FE6", borderWidth: 1, paddingVertical: 6 }, rateText: { color: "#61749E", fontSize: 11, fontWeight: "800" }, rateTextSelected: { color: "#4669DE" }, groupLabel: { color: "#61749E", fontSize: 11, fontWeight: "900", letterSpacing: 0.6, lineHeight: 16, marginBottom: 6 }, silenceRow: { flexDirection: "row", gap: 8 }, numberCard: { backgroundColor: "rgba(234,242,255,0.7)", borderColor: "rgba(255,255,255,0.88)", borderRadius: 14, borderWidth: 1, flex: 1, minHeight: 76, paddingHorizontal: 8, paddingVertical: 8 }, numberLabelRow: { alignItems: "center", flexDirection: "row", gap: 4, minHeight: 18 }, numberLabel: { color: "#35518E", fontSize: 12, fontWeight: "900", includeFontPadding: true, lineHeight: 18 }, numberValue: { alignItems: "center", backgroundColor: "rgba(255,255,255,0.72)", borderColor: "rgba(190,207,240,0.72)", borderRadius: 9, borderWidth: 1, flexDirection: "row", marginTop: 6, minHeight: 33, paddingLeft: 7 }, numberInput: { color: "#182B55", flex: 1, fontSize: 19, fontVariant: ["tabular-nums"], fontWeight: "900", lineHeight: 25, minWidth: 28, paddingVertical: 1 }, stepper: { alignSelf: "stretch", borderLeftColor: "rgba(165,187,228,0.6)", borderLeftWidth: 1, justifyContent: "center", marginLeft: 3 }, stepButton: { alignItems: "center", height: 18, justifyContent: "center", paddingHorizontal: 2 }, unit: { color: "#4669DE", fontSize: 11, fontWeight: "800", lineHeight: 16, marginHorizontal: 5 }, profilePanel: { backgroundColor: "rgba(226,236,255,0.62)", borderColor: "rgba(255,255,255,0.82)", borderRadius: 16, borderWidth: 1, marginTop: 12, padding: 12 }, profileHeader: { alignItems: "center", flexDirection: "row" }, profileIcon: { alignItems: "center", backgroundColor: "rgba(255,255,255,0.76)", borderRadius: 9, height: 30, justifyContent: "center", width: 30 }, profileCopy: { flex: 1, marginLeft: 8, minWidth: 0 }, profileTitle: { color: "#263E81", fontSize: 13, fontWeight: "900", lineHeight: 18 }, profileHint: { color: "#526588", fontSize: 10, lineHeight: 14, marginTop: 1 }, profileStats: { flexDirection: "row", gap: 5, marginTop: 9 }, profileSilenceRow: { flexDirection: "row", gap: 8, marginTop: 9 }, profileStat: { backgroundColor: "rgba(255,255,255,0.62)", borderColor: "rgba(255,255,255,0.78)", borderRadius: 9, borderWidth: 1, flex: 1, minHeight: 47, paddingHorizontal: 7, paddingVertical: 7 }, profileStatValue: { color: "#4669DE", fontSize: 12, fontWeight: "900", lineHeight: 18 }, profileStatLabel: { color: "#61749E", fontSize: 9, fontWeight: "700", includeFontPadding: true, lineHeight: 14, marginTop: 1 }, profileSilenceStat: { alignItems: "flex-start", backgroundColor: "rgba(255,255,255,0.76)", borderColor: "rgba(173,195,236,0.7)", borderRadius: 10, borderWidth: 1, flex: 1, justifyContent: "center", minHeight: 54, minWidth: 0, paddingHorizontal: 10, paddingVertical: 8 }, profileSilenceLabel: { color: "#526588", fontSize: 11, fontWeight: "800", lineHeight: 16 }, profileSilenceValue: { color: "#365AC9", fontSize: 13, fontWeight: "900", lineHeight: 18, marginTop: 2 },
});
