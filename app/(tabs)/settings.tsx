...
const styles = StyleSheet.create({
  page: { flex: 1, paddingTop: 9 }, topBar: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", paddingBottom: 10 }, titleGroup: { flex: 1, minWidth: 0, paddingRight: 12 }, title: { color: "#182033", fontSize: 25, fontWeight: "900", letterSpacing: -0.4 }, subtitle: { color: "#65708A", fontSize: 12, marginTop: 3 }, topSave: { alignItems: "center", backgroundColor: "#2F4DA0", borderRadius: 12, flexDirection: "row", gap: 4, paddingHorizontal: 13, paddingVertical: 10 }, topSaveDisabled: { backgroundColor: "#A9B5D5" }, topSaveText: { color: "#FFFFFF", fontSize: 13, fontWeight: "800" }, card: { backgroundColor: "#FFFFFF", borderColor: "#E4E8F0", borderRadius: 18, borderWidth: 1, flex: 1, justifyContent: "space-between", minHeight: 0, overflow: "hidden", padding: 12 }, formatRow: { alignItems: "center", flexDirection: "row" }, formatIcon: { alignItems: "center", backgroundColor: "#E8F7EF", borderRadius: 10, height: 32, justifyContent: "center", width: 32 }, formatCopy: { flex: 1, marginLeft: 8 }, formatTitle: { color: "#182033", fontSize: 15, fontWeight: "900" }, formatHint: { color: "#65708A", fontSize: 11, fontWeight: "700", marginTop: 1 }, fixedBadge: { backgroundColor: "#E8F7EF", borderRadius: 8, color: "#1E8B61", fontSize: 12, fontWeight: "900", overflow: "hidden", paddingHorizontal: 8, paddingVertical: 5 }, divider: { backgroundColor: "#E8EBF3", height: 1, marginVertical: 8 }, settingLine: { alignItems: "center", flexDirection: "row", minHeight: 40 }, lineLabel: { color: "#3F4A62", fontSize: 13, fontWeight: "800", width: 74 }, lineControl: { flex: 1 }, segment: { backgroundColor: "#EEF1F7", borderRadius: 9, flexDirection: "row", padding: 2 }, segmentItem: { alignItems: "center", borderRadius: 7, flex: 1, paddingVertical: 6 }, segmentSelected: { backgroundColor: "#FFFFFF", elevation: 1 }, segmentText: { color: "#65708A", fontSize: 12, fontWeight: "800" }, segmentTextSelected: { color: "#2F4DA0" }, rateGrid: { flexDirection: "row", gap: 5 }, rateChip: { alignItems: "center", backgroundColor: "#F2F4F8", borderRadius: 8, flex: 1, paddingVertical: 7 }, rateChipSelected: { backgroundColor: "#E7EEFF", borderColor: "#2F4DA0", borderWidth: 1, paddingVertical: 6 }, rateText: { color: "#65708A", fontSize: 11, fontWeight: "800" }, rateTextSelected: { color: "#2F4DA0" }, groupLabel: { color: "#65708A", fontSize: 11, fontWeight: "900", letterSpacing: 0.6, marginBottom: 6 }, silenceRow: { flexDirection: "row", gap: 8 }, numberCard: { backgroundColor: "#EDF3FF", borderColor: "#AFC4F5", borderRadius: 12, borderWidth: 1, flex: 1, paddingHorizontal: 8, paddingVertical: 7 }, numberLabelRow: { alignItems: "center", flexDirection: "row", gap: 4 }, numberLabel: { color: "#35518E", fontSize: 12, fontWeight: "900" }, numberValue: { alignItems: "center", backgroundColor: "#FFFFFF", borderColor: "#C9D8F6", borderRadius: 8, borderWidth: 1, flexDirection: "row", marginTop: 6, paddingLeft: 7 }, numberInput: { color: "#182033", flex: 1, fontSize: 19, fontVariant: ["tabular-nums"], fontWeight: "900", minWidth: 28, padding: 0 }, stepper: { alignSelf: "stretch", borderLeftColor: "#D4E0F6", borderLeftWidth: 1, justifyContent: "center", marginLeft: 3 }, stepButton: { alignItems: "center", height: 18, justifyContent: "center", paddingHorizontal: 2 }, unit: { color: "#2F4DA0", fontSize: 11, fontWeight: "800", marginHorizontal: 5 }, profilePanel: { backgroundColor: "#EEF3FF", borderRadius: 13, marginTop: 10, padding: 10 }, profileHeader: { alignItems: "center", flexDirection: "row" }, profileIcon: { alignItems: "center", backgroundColor: "#FFFFFF", borderRadius: 9, height: 30, justifyContent: "center", width: 30 }, profileCopy: { flex: 1, marginLeft: 8 }, profileTitle: { color: "#263E81", fontSize: 13, fontWeight: "900" }, profileHint: { color: "#526588", fontSize: 10, lineHeight: 13, marginTop: 1 }, profileStats: { flexDirection: "row", gap: 5, marginTop: 9 }, profileSilenceRow: { flexDirection: "row", gap: 5, marginTop: 5 }, profileStat: { backgroundColor: "rgba(255,255,255,0.78)", borderRadius: 9, flex: 1, paddingHorizontal: 7, paddingVertical: 6 }, profileStatValue: { color: "#2F4DA0", fontSize: 12, fontWeight: "900" }, profileStatLabel: { color: "#65708A", fontSize: 9, fontWeight: "700", marginTop: 1 }, note: { alignItems: "center", backgroundColor: "#EAF0FF", borderRadius: 12, flexDirection: "row", gap: 8, marginTop: 8, paddingHorizontal: 12, paddingVertical: 8 }, noteText: { color: "#415273", flex: 1, fontSize: 11, lineHeight: 14 },
});
