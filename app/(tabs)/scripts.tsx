...
const styles = StyleSheet.create({
  header: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", marginBottom: 22, paddingTop: 10 }, headerCopy: { flex: 1, paddingRight: 12 }, title: { color: "#182B55", fontSize: 29, fontWeight: "800", letterSpacing: -0.5 }, subtitle: { color: "#61749E", fontSize: 14, marginTop: 4 }, addButton: { alignItems: "center", backgroundColor: "rgba(70,105,222,0.92)", borderColor: "rgba(255,255,255,0.82)", borderRadius: 18, borderWidth: 1, elevation: 4, flexShrink: 0, height: 46, justifyContent: "center", shadowColor: "#3D59AF", shadowOpacity: 0.22, shadowRadius: 13, width: 46 }, list: { gap: 12, paddingBottom: 28 }, emptyList: { flexGrow: 1, justifyContent: "center", paddingBottom: 80 }, card: { alignItems: "center", borderRadius: 20, flexDirection: "row" }, cardMain: { alignItems: "center", flex: 1, flexDirection: "row", gap: 13, padding: 15 }, icon: { alignItems: "center", backgroundColor: "rgba(224,235,255,0.92)", borderRadius: 14, height: 48, justifyContent: "center", width: 48 }, cardBody: { flex: 1, gap: 5 }, cardTitle: { color: "#182B55", fontSize: 16, fontWeight: "700" }, cardSubtitle: { color: "#61749E", fontSize: 13 }, progressTrack: { backgroundColor: "rgba(115,142,196,0.18)", borderRadius: 99, height: 5, overflow: "hidden" }, progress: { backgroundColor: "#49AE7A", borderRadius: 99, height: "100%" }, deleteButton: { alignItems: "center", alignSelf: "stretch", borderLeftColor: "rgba(113,134,177,0.16)", borderLeftWidth: 1, justifyContent: "center", width: 48 }, empty: { alignItems: "center", paddingHorizontal: 26 }, emptyTitle: { color: "#182B55", fontSize: 19, fontWeight: "800", marginTop: 15 }, emptyText: { color: "#61749E", fontSize: 14, lineHeight: 22, marginTop: 8, textAlign: "center" }, exampleBox: { alignSelf: "stretch", backgroundColor: "rgba(255,255,255,0.54)", borderColor: "rgba(255,255,255,0.88)", borderRadius: 15, borderWidth: 1, marginTop: 14, padding: 12 }, exampleLabel: { color: "#526A9F", fontSize: 11, fontWeight: "900", letterSpacing: 0.4, marginBottom: 6 }, exampleCode: { color: "#4669DE", fontFamily: "monospace", fontSize: 12, lineHeight: 18 }, importButton: { backgroundColor: "rgba(70,105,222,0.92)", borderColor: "rgba(255,255,255,0.78)", borderRadius: 15, borderWidth: 1, marginTop: 21, paddingHorizontal: 23, paddingVertical: 13 }, importText: { color: "#FFFFFF", fontSize: 15, fontWeight: "800" },
});
